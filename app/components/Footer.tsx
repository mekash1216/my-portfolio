    ...
    <footer className="bg-gradient-to-r from-slate-800 via-gray-900 to-slate-800 text-gray-300 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
          {/* Brand */}
          <h3 className="text-xl sm:text-2xl font-semibold text-white tracking-wide hover:text-blue-400 transition">
            Mekash H.
          </h3>
          ...
          <button
            ...
            className="group flex items-center gap-2 text-sm sm:text-base border border-gray-600 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full
